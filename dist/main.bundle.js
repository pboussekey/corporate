...
var FormComponent = (function () {
    ...
    FormComponent.prototype.onSubmit = function (contact) {
        ...
        this.http.get('assets/mail.php?institution=' + contact.institution + "&email=" + contact.email + "&password=" + contact.password).subscribe(function (data) {
